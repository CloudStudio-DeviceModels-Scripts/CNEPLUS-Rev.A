...
# Parsing + Configuration Script – CNEPLUS - Rev. A

This **Parsing + Configuration** script is designed for the **CNEPLUS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – CNEPLUS Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **CNEPLUS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
